...
type Store struct {
	...
	ResolutionBatches   *ConflictResolutionBatchRepository
	ResolutionBatchRuns *ConflictResolutionBatchRunRepository
}
...
func NewStore(db *gorm.DB) *Store {
	return &Store{
		...
		ResolutionBatches:   &ConflictResolutionBatchRepository{db},
		ResolutionBatchRuns: &ConflictResolutionBatchRunRepository{db},
	}
}
...
func MigrateAndSeed(db *gorm.DB) error {
	if err := db.AutoMigrate(&model.User{}, &model.AuditLog{}, &model.LandParcel{}, &model.SurveyObservation{}, &model.BoundaryProposal{}, &model.TopologyConflict{}, &model.TopologyDetectionRun{}, &model.ConflictResolutionBatch{}, &model.ConflictResolutionBatchItem{}, &model.ConflictResolutionBatchRun{}); err != nil {
